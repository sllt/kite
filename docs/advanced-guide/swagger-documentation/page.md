# Rendering OpenAPI Documentation in Kite

Kite supports automatic rendering of OpenAPI (also known as Swagger) documentation. This feature allows you to
...
## Enabling Kite to render your openapi.json file

To allow Kite to render your OpenAPI documentation, simply place your `openapi.json` file inside the `static` directory of your project.
Kite will automatically render the Swagger documentation at the `/.well-known/swagger` endpoint.
