...
func TestCheckAndCreateMigrationTableSuccess(t *testing.T) {
	...
	mocks.SQL.ExpectExec(createSQLKiteMigrationsTable).WillReturnResult(mocks.SQL.NewResult(1, 1))
...
func TestCheckAndCreateMigrationTableExecError(t *testing.T) {
	...
	mocks.SQL.ExpectExec(createSQLKiteMigrationsTable).WillReturnError(expectedErr)
...
func TestGetLastMigration_UseMigratorFallback(t *testing.T) {
	...
	mocks.SQL.ExpectQuery(getLastSQLKiteMigration).
...
func TestCheckAndCreateMigrationTable_ErrorCreatingTable(t *testing.T) {
	...
	mockContainer, mocks := infra.NewMockContainer(t)
	mocks.SQL.ExpectExec(createSQLKiteMigrationsTable).WillReturnError(errCreateTable)
