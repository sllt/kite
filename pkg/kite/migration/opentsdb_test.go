...
func openTSDBSetup(t *testing.T) (migrator, *infra.Container, string) {
	t.Helper()
	...
	if mockOpenTSDB == nil {
		t.Fatal("mockOpenTSDB is nil - check infra.NewMockContainer implementation")
	}
...
func runEnhancedTestCase(t *testing.T, tc struct {
	...
	var mockContainer *infra.Container
	...
	if tc.desc == "empty file path directory (current directory)" {
		...
		mockContainer2, mocks := infra.NewMockContainer(t)
...
func Test_OpenTSDBCheckAndCreateMigrationTable_EdgeCases(t *testing.T) {
	testCases := []struct {
		desc        string
		setupFunc   func(t *testing.T) (migrator, *infra.Container, string)
		expectedErr string
	}{
		{
...
func setupVeryLongPath(t *testing.T) (migrator, *infra.Container, string) {
	t.Helper()
	mockContainer, mocks := infra.NewMockContainer(t)
...
func setupSpecialCharPath(t *testing.T) (migrator, *infra.Container, string) {
	t.Helper()
	mockContainer, mocks := infra.NewMockContainer(t)
...
func setupUnicodePath(t *testing.T) (migrator, *infra.Container, string) {
	t.Helper()
	mockContainer, mocks := infra.NewMockContainer(t)
...
func setupDeepPath(t *testing.T) (migrator, *infra.Container, string) {
	t.Helper()
	mockContainer, mocks := infra.NewMockContainer(t)
...
func setupDotPath(t *testing.T) (migrator, *infra.Container, string) {
	t.Helper()
	mockContainer, mocks := infra.NewMockContainer(t)
