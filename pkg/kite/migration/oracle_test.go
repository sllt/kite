...
func Test_OracleGetLastMigration(t *testing.T) {
	...
	for i, tc := range testCases {
		mockOracle.EXPECT().Select(gomock.Any(), gomock.Any(), getLastOracleKiteMigration).Return(tc.err)
...
func Test_OracleCommitMigration(t *testing.T) {
	...
	mockTxSuccess.EXPECT().
		ExecContext(gomock.Any(), insertOracleKiteMigrationRow,
...
func TestOracleMigration_RunMigrationSuccess(t *testing.T) {
	...
	mockOracle.EXPECT().Select(gomock.Any(), gomock.Any(), getLastOracleKiteMigration).Return(nil)
	...
	mockTx.EXPECT().ExecContext(gomock.Any(), insertOracleKiteMigrationRow,
...
func TestOracleMigration_GetLastMigration_ReturnsZeroOnError(t *testing.T) {
	...
	mockOracle.EXPECT().Select(gomock.Any(), gomock.Any(), getLastOracleKiteMigration).Return(sql.ErrConnDone)
