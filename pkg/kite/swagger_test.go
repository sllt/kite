...
func TestOpenAPIHandler_Error(t *testing.T) {
	...
	errors.Is(err, &os.PathError{Path: "/Users/raramuri/Projects/github.com/sllt/kite/kite/pkg/kite/static/openapi.json"})
...
func TestSwaggerUIHandler_Error(t *testing.T) {
	...
	assert.Nil(t, resp)
	errors.Is(err, &os.PathError{Path: "/Users/raramuri/Projects/github.com/sllt/kite/kite/pkg/kite/static/abc.abc"})
}
