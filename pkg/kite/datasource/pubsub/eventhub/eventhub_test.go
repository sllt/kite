...
func TestConnect(t *testing.T) {
	...
	client.UseTracer(otel.GetTracerProvider().Tracer("kite-eventhub"))
...
func TestCreateTopic_ForMigrations(t *testing.T) {
	...
	err := client.CreateTopic(t.Context(), "kite_migrations")

	require.NoError(t, err, "CreateTopic should not return an error for 'kite_migrations'")
}
