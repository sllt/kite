...
// Source: github.com/sllt/kite/pkg/kite/infra (interfaces: DB)
//
// Generated by this command:
//
//	mockgen -package=dbresolver -destination=mock_db.go github.com/sllt/kite/pkg/kite/infra DB
//
...
func (m *MockDBResolverProvider) GetResolver() infra.DB {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResolver")
	ret0, _ := ret[0].(infra.DB)
	return ret0
}
