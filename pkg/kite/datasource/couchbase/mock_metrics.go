...
// Source: pkg/kite/datasource/couchbase/metrics.go
//
// Generated by this command:
//
//	mockgen -source=pkg/kite/datasource/couchbase/metrics.go -destination=pkg/kite/datasource/couchbase/mock_metrics.go -package=couchbase
//
