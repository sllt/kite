...
var (
	_ infra.OracleDB = (*Client)(nil)
	_ infra.OracleTx = (*oracleTx)(nil)
)
...
// The method provides a standardized entry point for write and schema operations across kite's supported databases,
// ensuring consistent usage patterns and compatibility with the kite datasource interface conventions.
...
// The dest parameter should be a pointer to a slice or other suitable infra.
...
func (c *Client) Begin() (infra.OracleTx, error) {
	if c.conn == nil {
