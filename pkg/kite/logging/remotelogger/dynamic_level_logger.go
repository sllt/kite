...
// SetShowCaller delegates to the underlying logger if it supports CallerConfigurer.
func (r *remoteLogger) SetShowCaller(show bool) {
	if cc, ok := r.Logger.(logging.CallerConfigurer); ok {
		cc.SetShowCaller(show)
	}
}
