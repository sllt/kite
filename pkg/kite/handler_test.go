...
func TestHandler_ServeHTTP_Timeout(t *testing.T) {
	...
	h.container = &infra.Container{Logger: logging.NewLogger(logging.FATAL)}
...
func TestHandler_catchAllHandler(t *testing.T) {
	...
	assert.Equal(t, kiteHTTP.ErrorInvalidRoute{}, err, "TEST Failed.\n")
}
...
func TestIntegration_ServerTimeout(t *testing.T) {
	...
	// Set Kite's built-in request timeout to 1 second
	...
	// Kite should return 408 Request Timeout
