...
import (
	...
	kiteRedis "github.com/sllt/kite/pkg/kite/datasource/redis"
	...
	ws "github.com/sllt/kite/pkg/kite/websocket"
)
...
func Test_newContainerDBInitializationFail(t *testing.T) {
	...
	db := container.SQL.(*kiteSql.DB)
	redis := container.Redis.(*kiteRedis.Redis)
...
func TestContainer_Close(t *testing.T) {
	...
	mockDB, sqlMock, _ := kiteSql.NewSQLMocks(t)
...
func TestContainer_CreateSetsAppNameAndVersion(t *testing.T) {
	...
	t.Run("empty config uses defaults", func(t *testing.T) {
		...
		assert.Equal(t, "kite-app", c.GetAppName())
