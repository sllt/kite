...
func Test_LoggingMiddlewareStringPanicHandling(t *testing.T) {
	...
	assert.Contains(t, logs, "github.com/sllt/kite/pkg/kite/http/middleware.testStringPanicHandler")
}
...
func Test_LoggingMiddlewareErrorPanicHandling(t *testing.T) {
	...
	assert.Contains(t, logs, "github.com/sllt/kite/pkg/kite/http/middleware.testErrorPanicHandler")
}
...
func Test_LoggingMiddlewareUnknownPanicHandling(t *testing.T) {
	...
	assert.Contains(t, logs, "github.com/sllt/kite/pkg/kite/http/middleware.testUnknownPanicHandler")
}
